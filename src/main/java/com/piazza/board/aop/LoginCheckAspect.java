...
public class LoginCheckAspect {
    @Around("@annotation(com.piazza.board.aop.LoginCheck) && @ annotation(loginCheck)")
    public Object adminLoginCheck(ProceedingJoinPoint proceedingJoinPoint, LoginCheck loginCheck) throws Throwable {
        ...
        if (id == null) {
            ...
            throw new HttpStatusCodeException(HttpStatus.UNAUTHORIZED, "Please Check Login ID.") {};
        }
